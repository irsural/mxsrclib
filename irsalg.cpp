...
double irs::student_t_inverse_distribution_2x(
  ...
  size_t a_degrees_of_freedom)
{
  ...
  double result = 0;
  switch (a_confidence_level) {
    case confidence_level_0_95: {
      double table_0_95[] = {
        // Для n от 1 до 50
    ...
    default: {
      IRS_LIB_ASSERT_MSG("Для указанного значения a_confidence_level функция не "
        "реализована");
    }
  }
  return result;
...
double irs::critical_values_for_t_a_criterion(
  ...
  size_t a_sample_size)
{
  ...
  double result = 0;
  switch (a_level_of_significance) {
    case level_of_significance_0_1: {
      // Для n от 3 до 25
      double table_0_1[] = {
    ...
    case level_of_significance_0_05: {
      // Для n от 3 до 25
      double table_0_05[] = {
    ...
    case level_of_significance_0_01: {
      // Для n от 3 до 25
      double table_0_01[] = {
    ...
    default: {
      IRS_LIB_ASSERT_MSG("Для указанного значения a_level_of_significance "
