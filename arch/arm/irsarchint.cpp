...
void irs_arm_exti0_func()
{
  ...
  // Крашенинников 16.01.2025: Эту строку написал Поляков 21.02.2018.
  //   В PR6 6 это номер по порядку в векторе прерываний NVIC
  //   А должно, на мой взгляд, быть PR0
  //   0 соответствует номеру в exti0
  //   Не стал пока исправлять, т. к. до конца непонятно правильно ли это
  EXTI_PR_bit.PR6 = 1;
}
...
void irs_arm_exti3_func()
{
  ...
  // Крашенинников 16.01.2025: Эту строку исправил Поляков 21.02.2018.
  //   В PR9 9 это номер по порядку в векторе прерываний NVIC
  //   А должно, на мой взгляд, быть PR3, как и было изначально у Лящова
  //   3 соответствует номеру в exti3
  //   Не стал пока исправлять, т. к. до конца непонятно правильно ли это
  EXTI_PR_bit.PR9 = 1;
}
