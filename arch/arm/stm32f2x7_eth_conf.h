...
#ifndef IRS_USE_STM32F2x7_ETH_PROJECT_CONFIGURATION
# define IRS_USE_STM32F2x7_ETH_PROJECT_CONFIGURATION 0
#endif // IRS_USE_STM32F2x7_ETH_PROJECT_CONFIGURATION
...
/* Redefinition of the Ethernet driver buffers size and count */
 ...
 #define ETH_RXBUFNB        2                   /* 4 Rx buffers of size ETH_RX_BUF_SIZE */
...
#define PHY_SR    ((uint16_t)0x1f) // Äëÿ KS8721bl
...
#define PHY_SPEED_STATUS            ((uint16_t)1<<2) /* Value for KS8721bl PHY */
#define PHY_DUPLEX_STATUS           ((uint16_t)1<<4) /* Value for KS8721bl PHY */
