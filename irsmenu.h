...
public:
  ...
  //! \brief Задает шаг по умолчанию. При изменении внешнего значения шаг
  //!   будет сбрасываться в это значение
  void set_default_step(double a_step);
  //! \brief Сбрасывает шаг по умолчанию. При изменении внешнего значения
  //!   шаг будет настраиваться автоматически
...
private:
  ...
  //! \brief Возвращает относительную позицию
  ...
  // Выбранный разряд. Справа от разделителя разряды нумеруются по убыванию,
  // слева направо, со знаком минус. Слева от разделителя разряды нумеруются по
